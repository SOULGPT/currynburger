...
export default function SignupPage() {
  ...
  const { signUp, signInWithGoogle, signInWithApple, continueAsGuest, user, authError, clearAuthError } = useAuth()
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFF9F3] via-[#FFF5E8] to-[#FFE8CC] dark:from-background dark:via-background dark:to-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">Join Curry&Burger</h1>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link href="/auth/login" className="text-[#E78A00] font-semibold hover:underline">
            Sign in
          </Link>
        </p>
      </Card>
